    ...
    <body>
        <div class="contenedorinvisiblesubirarchivo">
            <div class="contenedor-principal">
                ...
                <form id="uploadForm" action="{{ route('subir.archivos') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div id="inputs-container">
                        @foreach ($tiposdoc as $index => $tipo)
                            <div class="labels input-group page-{{ intdiv($index, 5) }}"
                    ...
                    <div class="pagination-buttons">
                        <button type="button" id="prevBtn" class="btn" onclick="changePage(-1)"
                            style="display: none;"><i class="fa-solid fa-backward"></i></button>
                        <button type="button" id="nextBtn" class="btn" onclick="changePage(1)"><i
